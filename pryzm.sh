...
read -p "Enter WALLET name:" PRWALLET
echo 'export PRWALLET='$PRWALLET
read -p "Enter your MONIKER :" PRMONIKER
echo 'export PRMONIKER='$PRMONIKER
read -p "Enter your PORT (for example 17, default port=26):" PRPORT
echo 'export PRPORT='$PRPORT

# set vars
echo "export PRWALLET="$PRWALLET"" >> $HOME/.bash_profile
echo "export PRMONIKER="$PRMONIKER"" >> $HOME/.bash_profile
echo "export PRYZM_CHAIN_ID="indigo-1"" >> $HOME/.bash_profile
echo "export PRYZM_PORT="$PRPORT"" >> $HOME/.bash_profile
source $HOME/.bash_profile

printLine
echo -e "Moniker:        \e[1m\e[32m$PRMONIKER\e[0m"
echo -e "Wallet:         \e[1m\e[32m$PRWALLET\e[0m"
...
chmod +x $HOME/pryzmd
mv $HOME/pryzmd /usr/local/bin/pryzmd
...
pryzmd init "$PRMONIKER" --chain-id indigo-1
sleep 1
echo done
